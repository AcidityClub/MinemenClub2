...
package club.minemen.spigot.event.inventory;
...
public class PrepareAnvilRepairEvent extends InventoryEvent implements Cancellable
{
    ...
    public PrepareAnvilRepairEvent(final HumanEntity repairer, final InventoryView view, final Block anvil, final ItemStack first, final ItemStack second, final ItemStack result) {
        super(view);
        this.first = first;
        this.second = second;
        this.anvil = anvil;
